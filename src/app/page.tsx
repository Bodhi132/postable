  ...
  return (
    <div className="bg-white w-full overflow-x-hidden flex flex-col">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col items-start gap-6 px-4 py-12 md:gap-12 md:py-24 xl:pe-4 xl:ps-0 mt-8 md:mt-0">
        <p className={`max-w-4xl text-balance text-3xl font-medium tracking-[-0.4px] text-neutral-400 md:text-[40px] md:leading-[42px] font-aspekta`}>We help you create postable content that <span className="text-neutral-800">not only looks great</span> but also
      ...
      <Solutions />
      <div className="mx-auto flex w-full max-w-6xl flex-col items-start gap-6 px-4 py-12 md:gap-12 md:py-24 xl:pe-4 xl:ps-0 mt-8 md:mt-0">
        <p className={`max-w-4xl text-balance text-3xl font-medium tracking-[-0.4px] text-neutral-400 md:text-[40px] md:leading-[42px] font-aspekta`}>We help you create postable content that not only <span className="text-neutral-800">looks great</span> but also
          <span className="text-neutral-800"> engages your audience</span>.</p>
        <button className="bg-black text-white px-3 py-3 flex items-center gap-2 rounded-xl hover:bg-neutral-800 transition-colors">
          <p className="font-bold">Get Started for FREE</p>
          <FaArrowRight className="text-sm" />
