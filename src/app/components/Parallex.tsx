...
import appScreenShot from '../../../public/app-screenshot.webp'
...
const Parallex = () => {
    ...
    const y = useTransform(scrollYProgress, [0, 1], [-640,1]);
        ...
        <div ref={divRef}>
            ...
            >
                <div className='mt-12 flex flex-col items-center md:mt-28'>
                    <h3 className="mb-4 text-3xl font-[750] tracking-[-0.2px] text-white md:mb-6 md:text-[60px] md:font-[850] md:leading-[54px] md:tracking-[-1px]">One-Click to Create</h3>
                    <p className="mb-2 max-w-md text-balance text-center text-md font-normal leading-relaxed text-neutral-400 md:max-w-2xl md:text-lg">Postable is built with simplicity and fun at its core. No design skills? No problem.
                        We handle the heavy lifting so you can effortlessly create stunning posts.</p>
                    <Link href='#' className='relative my-8 inline-flex w-fit items-center justify-center gap-1 whitespace-nowrap rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-semibold leading-6 tracking-[-0.3px] text-white transition-colors hover:bg-neutral-800 md:px-6 md:py-3 md:text-lg'>
                        Get Started for FREE
                        <FaArrowRight className='' />
                    </Link>
                </div>
                <div className="relative mx-auto w-full max-w-7xl ">
                    <Image src={appScreenShot} alt="Last Section" />
                </div>
            </div>
            <footer className='relative z-0 -mt-32 overflow-hidden bg-cover bg-center' 
            style={{ backgroundImage: 'url("https://res.cloudinary.com/dzv61qpeu/image/upload/v1726153159/footer-background_nfg8rf.webp")' }}>
                <motion.div className="mx-auto mt-12 w-full max-w-6xl flex-col px-4 pt-48 sm:px-12 md:pb-24 xl:pe-4 xl:ps-0" style={{y}} ref={footerRef}>
                    <svg
                        width={112}
                        height={16}
                        viewBox="0 0 112 16"
                    ...
                    >
                        ...
                        <defs>
                            <clipPath id="clip0_4412_5268">
                                <rect width="111.2" height={16} fill="white" />
                            </clipPath>
                        </defs>
                    </svg>
                    <div className="flex flex-col gap-12 lg:flex-row">
                        <div className="flex-shrink-0">
                            <p
                                className="mb-2 text-lg font-bold text-white/60 md:text-[22px]"
                            ...
                            <p className="w-fit max-w-md text-xs font-normal leading-[18px] text-white/60 md:text-balance md:text-md">
                                ...
                                create engaging content that go beyond the ordinary.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-4">
                        <div className="grid grid-cols-2 grid-rows-2 gap-2 sm:flex sm:flex-wrap">
                            ...
                            <a
                                className="flex min-w-32 items-center gap-3 rounded-lg bg-black/20 p-2.5 transition-colors hover:bg-black/30 sm:min-w-40"
                                target="_blank"
                                href="https://discord.gg/D857XpAFWE"
                            >
                                <svg
                                    width={28}
                                    height={28}
                                ...
                                <div>
                                    ...
                                    <span className="block text-sm font-medium text-white">Discord</span>
                                </div>
                            </a>
                            <a
                                className="flex min-w-32 items-center gap-3 rounded-lg bg-black/20 p-2.5 transition-colors hover:bg-black/30 sm:min-w-40"
